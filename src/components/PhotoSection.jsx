...
const PhotoSection = ({ 
  ...
  const defaultImages = [
    { src: '/assets/images/prenup/DE_00873.jpg', alt: 'Photo 1', label: 'Memories' },
    { src: '/assets/images/prenup/DE_00846.jpg', alt: 'Photo 2', label: 'Together' },
    { src: '/assets/images/prenup/DE_00876.jpg', alt: 'Photo 3', label: 'Love' }
  ]
